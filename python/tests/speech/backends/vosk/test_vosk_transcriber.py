...
from robot_friend.speech.backends.vosk.vosk_speech_detector import VoskSpeechDetector, _decode
...
def _transcriber(recognizers: dict[Language, FakeRecognizer]) -> VoskSpeechDetector:
    transcriber = VoskSpeechDetector.__new__(VoskSpeechDetector)  # skip model loading
